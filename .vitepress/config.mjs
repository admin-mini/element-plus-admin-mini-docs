...
export default defineConfig({
  ...
  base: "/element-plus-admin-mini-docs/",
  title: "element-plus-admin-mini",
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/admin-mini/element-plus-admin-mini' },
      {
        icon: {
        ...
        }, link: 'https://gitee.com/admin-mini/element-plus-admin-mini'
      },
    ]
  }
})
